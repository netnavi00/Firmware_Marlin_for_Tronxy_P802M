...
#define STRING_CONFIG_H_AUTHOR "(Atiesh, 2019)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "JEVN - Tronxy P802M"
 ...
 */
#define TEMP_SENSOR_0 13  // hotend
